...
var p=H.page('Proto iOS Light');p.layers.slice().forEach(function(l){if(l.name==='Screen/ios/'+APP+'/search'||(/^caption\//.test(l.name)&&l.name.endsWith('/search')))l.remove();});build('search',6);
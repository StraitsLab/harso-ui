...
var p=H.page('Proto iOS Dark');p.layers.slice().forEach(function(l){if(l.name==='Screen/ios/'+APP+'/home'||(/^caption\//.test(l.name)&&l.name.endsWith('/home')))l.remove();});build('home',1);
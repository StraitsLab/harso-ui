...
var PAGE = 'Proto iOS Dark'; var PATH = ["home", "conversation", "conversation--menu", "conversation--delete", "back", "back", "activity", "activity--work", "back", "projects", "projects--new", "project--empty", "settings", "settings-billing", "settings-billing--plan", "back", "settings--sign-out", "signin"]; // sequence of link ids to click starting from the start screen

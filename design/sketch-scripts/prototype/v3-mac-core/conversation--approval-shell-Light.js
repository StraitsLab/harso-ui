var APP="Light/Clean", ID="conversation--approval", INDEX=3, PHASE="shell";
var app=APP;
...
var w = H.macWindow(s, app, { rail: rail, active: 'conversation', title: 'Move the billing webhook handler', subtitle: 'Personal · 14 turns', tools: [['link:conversation--menu', 'ellipsis'], ['share', 'square_and_arrow_up']], collapseLink:'conversation--rail', inspector: 'Context', inspectorToggle: 'conversation' });
w.finish();finish();
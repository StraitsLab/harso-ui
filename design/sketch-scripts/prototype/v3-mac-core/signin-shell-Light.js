var APP="Light/Clean", ID="signin", INDEX=0, PHASE="shell";
var app=APP;
...
var w=H.macWindow(s,APP,{"rail": false, "active": "signin", "title": "Welcome to Weave", "search": false, "inspector": false, "collapseLink": "back", "inspectorClose": "activity"});named(w.sidebar,'list').remove();named(w.sidebar,'link:settings').remove();w.finish();finish();
...
['alert','stacked','destructive','input'].forEach(v=>{var s=specimen(v);var c=sym(s.r,v,360,24,16);tx(c,v==='destructive'?'Delete this project?':v==='input'?'Rename project':'Save your changes?',16,'ink',312,6);tx(c,v==='destructive'?'This action cannot be undone. Your project and its contents will be removed.':'Your work stays in place. Save your changes before you continue.',14,'secondary',312);if(v==='input')field(c,'Research studio',312);spacer(c,8);var a=fr(c,'actions',v==='stacked'?'col':'row',312,undefined,0,8);btn(a,'Cancel',false,v==='stacked'?312:152);btn(a,v==='destructive'?'Delete':v==='input'?'Rename':'Save changes',true,v==='stacked'?312:152,v==='destructive');done(a);done(c);end(s);});

...
var s=specimen('Titled inset group');var c=sym(s.r,'default',420,16,12);tx(c,'Project settings',14,'ink',undefined,6);[['Workspace','Research studio'],['Visibility','Private'],['Notifications','Enabled']].forEach((a,i)=>{var r=fr(c,'row','row',388,32,0,8);tx(r,a[0],13,'secondary',120);flex(r);tx(r,a[1],13);ic(r,'chevronsUpDown',14);done(r);if(i<2)line(c,388,16);});done(c);end(s);

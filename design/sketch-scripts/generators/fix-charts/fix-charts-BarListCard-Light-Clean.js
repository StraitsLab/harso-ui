var APP="Light/Clean";var CFG=["BarListCard", "barlist", "Bar List Card", "Illustrative host values \u00b7 no inferred totals", ["Stage 1", "Stage 2", "Stage 3"]];
...
if(kind==='contributions') {HH=80;['Mon','Tue'].forEach((v,i)=>{text(0,20+i*40,v);rect(60,11+i*40,820,10,g);rect(60,11+i*40,410*(i+1),10,a);text(960,20+i*40,[4,8][i],'end',C.ink);});}
...
if(kind==='sleep'){
HH=185;arc(480,167,130,Math.PI,Math.PI*2,g,24);arc(480,167,130,Math.PI+Math.PI/3,Math.PI+Math.PI/3+Math.PI/12,b,24);arc(480,167,130,Math.PI+Math.PI*2/3,Math.PI+Math.PI*2/3+Math.PI/6,c,24);}
if(kind==='scatter'){

...
var r=row('Compact scale for clear, everyday work');var b=sy(r,'specimen/default',{dir:'col',gap:20,align:sketch.StackLayout.AlignItems.Start});[['Display · 24','A little more clarity.',24,'ink',6],['Heading · 20','Make room for focused work',20,'ink',6],['Section · 16','Everything in its right place',16,'ink',6],['Body · 15','Keep the conversation moving.',15,'ink',5],['Body · 14','Your workspace is up to date',14,'ink',5],['Secondary · 13','Bring references, decisions, and next steps together.',13,'secondary',5],['Caption · 12','Updated just now · Visible to your team',12,'tertiary',5],['Mono · 13','src/workspace.tsx',13,'secondary',5],['Link','Explore your workspace →',14,'accent',6]].forEach(a=>{var q=fr(b,'type row',{gap:24});tx(q,a[0],12,'tertiary',140);var t=tx(q,a[1],a[2],a[3],640,a[4]);if(a[0].startsWith('Mono'))t.style.fontFamily='JetBrains Mono';});

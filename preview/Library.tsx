    ...
    <div className="hkl-layout">
      ...
      <main ref={mainRef} className="hkl-main" id="component-preview" tabIndex={-1}>
        ...
        {implementation ? <>
          ...
          <section className="hkl-specification"><h2>Behavior, not decoration.</h2><p>{notes?.behavior}</p><pre><code>{notes?.example}</code></pre><p className="hkl-proof-note">Interactive local example · synthetic state · full reference parity remains under review</p></section>
